...
export function IconTrophy({ size = 13 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M17 4H7l-1 6c0 3.31 2.69 6 6 6s6-2.69 6-6l-1-6z" />
...
export function IconGamepad({ size = 13 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconHeart({ size = 13 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconMessage({ size = 13 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
